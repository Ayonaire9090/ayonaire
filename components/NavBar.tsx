  ...
  return (
    <>
      <nav className="fixed top-4 left-0 right-0 z-50 px-4">
        <div className="mx-auto w-full max-w-[1280px] overflow-hidden rounded-2xl border border-gray-100 bg-white/95 backdrop-blur-md shadow-[0_8px_30px_rgba(0,0,0,0.08)]">
