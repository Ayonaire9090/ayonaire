...
export interface AssignmentsInfoAnalyticsCardProps {
  heading: string;
  title: string;
  rate?: string;
...
export const AssignmentsInfoAnalyticsCard = ({
  heading,
  title,
  rate,
  statusBadge,
  ...
  return (
    <div className="rounded-[16px] w-full min-w-[250px] p-4 flex flex-col justify-between bg-white border border-gray-100 shadow-xs h-full min-h-[160px] gap-6">
      <div className="flex flex-col gap-3">
        <div className="flex justify-between items-center text-[16px] font-medium text-gray-500">
          {heading}
          {statusBadge && (
            <div
