    ...
    <div className="flex flex-col w-full gap-6 bg-white rounded-2xl p-4 md:p-6 lg:p-8">
      ...
      {!selectedCourse ? (
        <>
          ...
          {/* Pagination Bottom - Only shown in empty state for now */}
      ...
      <EnrollmentProgressModal
        ...
        onComplete={() => {
          ...
          // Return to the main list after completing
          onBack();
        }}
      />
      ...
      <CourseSelectionModal
        ...
        onSelect={(course) => {
          ...
          // Auto-open student selection immediately for better UX
      ...
      <StudentSelectionModal
        ...
        onAddStudents={(students) => {
          // Overwrite or append? The UI looks like we append if we open again.
          // However "selectedIds" inside modal gets reset, so overwriting or deduplicating is useful.
          // For simplicity let's just use what they return as the new list.
          // Wait, if they open the modal again, and click add, we append avoiding duplicates:
      ...
      <CsvUploadModal
        ...
        onUpload={() => {
          ...
          // Show CSV enrollment complete modal
