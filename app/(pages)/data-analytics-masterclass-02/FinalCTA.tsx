  ...
  return (
    <>
      <section className="w-full px-6 py-6 sm:px-8 lg:px-12 flex justify-center mt-4">
        {/* Replaced solid background with the image container */}
        <div className="relative w-full rounded-[12px] overflow-hidden px-6 py-10 text-center text-white shadow-xl sm:px-12 sm:py-12">
          {/* Background image using lt.png */}
          <Image
            src="/assets/images/lk.png"
            alt="Background"
            fill
            className="object-cover object-center pointer-events-none"
            priority
          />
          {/* Subtle overlay so text remains readable over the image */}

          <div className="relative z-10 flex flex-col items-center font-sans">
            <h2
              className={`${sora.className} ${typeScale.h2} font-extrabold tracking-tight mb-3`}
            >
              Get Instant{" "}
              <span className="relative inline-block rounded-md bg-[#F25E25]/10 px-2.5 py-0.5 text-[#F67219]">
                <span
                  aria-hidden="true"
            ...
            <p
              className={`${typeScale.body} max-w-2xl font-medium text-white/95 tracking-wide mb-6`}
            >
              This free session gives more than most $200 masterclasses out
              there. The feedback says it all.
            </p>
      ...
      <section className="w-full px-6 pb-16 sm:px-8 lg:px-12 flex justify-center mt-14">
        <div className="w-full max-w-6xl">
          <h3
            className={`${sora.className} ${typeScale.h2} mb-8 text-center font-bold text-[#121315]`}
          >
                ...
                >
                  <span className="flex h-[60px] w-[60px] items-center justify-center rounded-xl bg-[#F67219]/10">
                    <Icon
                      size={30}
                      strokeWidth={1.75}
                      className="text-[#F67219]"
                    />
                  </span>
                  <span className={`${typeScale.caption} text-gray-500`}>
                    {detail.label}
                  </span>
                  <div>
                    ...
                    <p className={`${typeScale.body} text-[#F67219]`}>
                      {detail.sub}
                    </p>
                  </div>
                </div>
