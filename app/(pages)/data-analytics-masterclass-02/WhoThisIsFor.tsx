      ...
      <section className="w-full bg-white py-8 md:py-14">
        ...
        >
          <div className="flex w-full flex-col gap-10 lg:flex-row lg:items-center lg:gap-14">
            {/* Left: heading + CTA (Takes up 50% of the space evenly) */}
            <div className="flex flex-1 flex-col items-start gap-7">
              <h2
                className={`${sora.className} ${typeScale.h2} w-full text-center font-bold leading-tight text-[#121315] lg:text-left lg:!text-5xl`}
              >
                This Live Masterclass{" "}
                <span className="relative inline-block rounded-md bg-[#F25E25]/10 px-2.5 py-0.5 text-[#F25E25]">
                  Is For You If:
                  <span
                    aria-hidden="true"
            ...
            {/* Right: checklist (Takes up the other 50% of the space evenly) */}
            <div className="flex flex-1 flex-col gap-4">
              {reasons.map((reason, index) => (
                ...
                >
                  ...
                  <p
                    className={`${sora.className} ${typeScale.body} text-lg! font-semibold leading-snug text-[#121315]`}
                  >
                    {reason}
                  </p>
                </div>
