...
export default function LearningPathSection() {
  return (
    <section className="bg-gradient-to-b from-[rgba(255,220,196,0.08)] to-[rgba(246,114,25,0.08)] px-5 py-16 sm:px-8 lg:px-12 xl:px-16 lg:py-[120px]">
          ...
          >
            ...
            <span className="relative inline-block text-[#f25e25]">
              ...
              <Image
                ...
                width={562}
                height={68}
                className="pointer-events-none absolute left-1/2 top-1/2 h-[68px] w-[min(562px,110%)] -translate-x-1/2 -translate-y-1/2 select-none object-fill"
              />
            </span>
          </h2>
        ...
        >
          <div className="mx-auto max-w-[1040px] space-y-6 px-0 text-[18px] leading-[1.65] tracking-[0.5px] lg:text-[28px] lg:leading-[1.65] lg:tracking-[1px]">
            ...
            <p className="font-bold">
              TRADITIONAL ROUTE {"->"} MODERN ROUTE {"->"} ADVANCED ROUTE
            </p>
            <p>And if you're thinking:</p>
            <p className="font-bold">&quot;Wait... I need to learn ALL of that?&quot;</p>
            <p>Yes</p>
            <p className="underline">
              But <strong>not all at once.</strong>
            </p>
            <p className="font-medium">
              You are not supposed to wake up tomorrow and try to learn Python,
              SQL, ML, RAG, AI Agents, Cloud, APIs and deployment in one
              sitting. The real challenge is not knowing the list of skills.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-9 text-center">
            ...
            <ol className="mx-auto max-w-[1090px] space-y-5 text-left">
              {stuckItems.map((item, index) => (
                <NumberedItem key={item} index={index + 1} text={item} compact />
              ))}
            </ol>
            ...
            >
              <p>
                ...
                <strong>how you need to learn</strong> are two different things.
              </p>
              <p>
                And that's exactly why I don't want you to look at this roadmap
                and feel like you now have another giant mountain to climb.
              </p>
            </div>
