    ...
    <section className="bg-gradient-to-b from-[rgba(255,255,255,0.09)] to-[rgba(242,94,37,0.09)] px-5 pb-16 sm:px-8 lg:px-12 lg:pb-[120px] xl:px-16">
      <div className="mx-auto flex w-full max-w-[1240px] flex-col items-center gap-12 text-center lg:gap-20">
        ...
        <div className="flex w-full flex-col gap-12 text-left lg:gap-[100px]">
          <div className={`${exoMedium.className} flex flex-col gap-8 text-justify text-[18px] leading-[1.6] tracking-[0.8px] text-[#5a4136] sm:text-[24px] lg:gap-11 lg:text-[28px] lg:leading-[40px] lg:tracking-[1.2px]`}>
          ...
          <div className="rounded-[20px] bg-white p-6 text-center sm:p-8 lg:rounded-[24px] lg:p-10">
            <div className={`${exoMedium.className} flex flex-col items-center gap-6 text-[#5a4136] lg:gap-11`}>
