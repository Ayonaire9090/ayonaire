      ...
      <div className="mx-auto flex w-full max-w-[777px] flex-col items-center justify-center gap-12 text-center lg:gap-20">
        <div className="flex w-full flex-col items-center gap-8">
          <div className="relative w-full max-w-[713px]">
            <h2 className={`${exo.className} relative z-10 text-[26px] xs:text-[30px] font-bold leading-[1.08] tracking-[-0.8px] text-[#181c23] sm:text-[44px] lg:text-[56px] lg:leading-[60.48px] lg:tracking-[-1.4px]`}>
        ...
        <div className="flex flex-col items-center gap-8 lg:gap-10">
          <p className={`${exoMedium.className} text-[16px] xs:text-[18px] font-bold leading-[1.55] tracking-[0.3px] text-[#f25e25] sm:text-[22px] lg:text-[24px] lg:leading-[38px] lg:tracking-[0.6px]`}>
            The question is: what will you have to show for them?
          </p>

          <a href="https://wa.link/f1iadg" target="_blank" rel="noopener noreferrer" className={`${exoMedium.className} inline-flex items-center justify-center gap-2 rounded-[8px] bg-[#ff6b00] px-5 py-3.5 text-center text-[13px] font-bold uppercase leading-[1.45] text-white shadow-[0_12px_16px_rgba(255,107,0,0.3)] transition-transform hover:scale-[1.01] sm:px-10 sm:py-5 lg:text-[16px]`}>
