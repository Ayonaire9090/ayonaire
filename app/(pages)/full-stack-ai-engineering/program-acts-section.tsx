...
export default function ProgramActsSection() {
  return (
    <section className="bg-gradient-to-b from-[rgba(255,255,255,0.09)] to-[rgba(242,94,37,0.09)] px-5 py-16 sm:px-8 lg:px-12 lg:py-[120px] xl:px-16">
      <div className="mx-auto flex w-full max-w-[1240px] flex-col items-center gap-14 lg:gap-20">
        ...
        <div className="relative flex w-full max-w-[846px] flex-col items-center gap-8 text-center lg:gap-12">
          <h2
            className={`${melodrama.className} text-[30px] font-bold uppercase leading-[1.12] tracking-[-0.8px] text-[#181c23] sm:text-[36px] lg:text-[44px] lg:leading-[1.16]`}
          >
            ...
            <span className="relative inline-block text-[#f25e25]">
              ...
              <Image
                ...
                width={344}
                height={68}
                className="pointer-events-none absolute left-1/2 top-1/2 h-[68px] w-[min(344px,112%)] -translate-x-1/2 -translate-y-1/2 object-fill"
              />
            </span>
          </h2>
  ...
  return (
    <article
      className={`
        ...
        bg-white
        p-6
        shadow-[0_6px_14px_rgba(24,28,35,0.10)]
        lg:p-10
        ${large ? "lg:px-14" : ""}
      `}
    >
      <h3
        className={`${exo.className} text-[20px] font-bold leading-[1.35] text-black lg:text-[24px]`}
      >
        {act.title}
      </h3>

      <p
        className={`${salt.className} mt-5 text-[18px] font-medium leading-[1.4] text-black lg:text-[20px]`}
      >
        {act.duration}
      </p>

      <p
        className={`${exoMedium.className} mt-5 text-[17px] leading-[1.65] text-[#181c23] lg:text-[22px]`}
      >
        {act.body}
      </p>
    </article>
