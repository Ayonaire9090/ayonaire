          ...
          <div className="flex flex-col gap-7 lg:gap-9">
            ...
            <div className="flex flex-col gap-6 lg:gap-8">
              {plans.map((plan) => (
                <article
                  key={plan.title}
                  className="relative flex aspect-[702/336] w-full items-center lg:max-w-[655px] overflow-hidden"
                >
                  <Image
                  ...
                  >
                    ...
                    {/* PLAN CONTENT */}
                    <div className="min-w-0 flex-1 sm:flex-none sm:w-[68%] space-y-1.5 text-[#181c23] sm:space-y-2 lg:space-y-2.5">
                      <h3
                        className={`
                          ${exo.className}
                          text-[14px]
