        ...
        {items.map((item) => (
          ...
          >
            ...
            >
              ...
              />
              <p className={`${rope.className} min-w-0 flex-1 sm:flex-none sm:w-[68%] text-[12px] font-bold leading-[1.6] tracking-[0.3px] text-[#181c23] sm:text-[15px] sm:leading-[1.5] lg:text-[19px] lg:leading-[1.5] xl:text-[20px]`}>
                {item}
              </p>
            </div>
          </article>
