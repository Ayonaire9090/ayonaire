    ...
    <section className="bg-[#fefefe] px-5 py-16 sm:px-8 sm:py-20 lg:px-12 lg:py-24 xl:px-16 xl:py-28">
      <div className="mx-auto flex w-full max-w-[1240px] flex-col gap-12 lg:gap-20">
        ...
        <a
          ...
          className={`${exo.className} mx-auto inline-flex items-center justify-center text-center gap-2 rounded-[8px] bg-[#ff6b00] px-5 py-3.5 xs:px-8 xs:py-4 text-[13px] xs:text-[14px] font-bold uppercase text-white shadow-[0_12px_16px_rgba(255,107,0,0.3)] transition-transform hover:scale-[1.01] sm:px-10 sm:py-5 lg:text-[18px]`}
        >
